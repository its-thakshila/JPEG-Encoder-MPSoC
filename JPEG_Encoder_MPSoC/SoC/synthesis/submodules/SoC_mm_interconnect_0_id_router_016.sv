...
module SoC_mm_interconnect_0_id_router_016_default_decode
  #(
...
module SoC_mm_interconnect_0_id_router_016
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    SoC_mm_interconnect_0_id_router_016_default_decode the_default_decode(
    ...
    always @* begin
        ...
        if (destid == 0 ) begin
            src_channel = 53'b000001;
        end

        if (destid == 10 ) begin
            src_channel = 53'b000010;
        end

        if (destid == 8 ) begin
            src_channel = 53'b000100;
        end

        if (destid == 6 ) begin
            src_channel = 53'b001000;
        end

        if (destid == 4 ) begin
            src_channel = 53'b010000;
        end

        if (destid == 2 ) begin
            src_channel = 53'b100000;
        end
