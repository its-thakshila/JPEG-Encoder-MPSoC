...
module SoC_mm_interconnect_0_addr_router_008_default_decode
  #(
...
module SoC_mm_interconnect_0_addr_router_008
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1011030;
    ...
    SoC_mm_interconnect_0_addr_router_008_default_decode the_default_decode(
