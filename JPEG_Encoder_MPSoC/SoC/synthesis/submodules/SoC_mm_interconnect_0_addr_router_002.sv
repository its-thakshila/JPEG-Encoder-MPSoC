...
(
    ...
    localparam PAD4 = log2ceil(64'h104100c - 64'h1041008); 
    localparam PAD5 = log2ceil(64'h1041010 - 64'h104100c); 
    localparam PAD6 = log2ceil(64'h1041014 - 64'h1041010); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1041014;
    ...
    // ( 0x1041008 .. 0x104100c )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 25'h1041008  && read_transaction  ) begin
            src_channel = 53'b1000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 39;
    end

    // ( 0x104100c .. 0x1041010 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 25'h104100c  && read_transaction  ) begin
            src_channel = 53'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 24;
    end

    // ( 0x1041010 .. 0x1041014 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 25'h1041010  && read_transaction  ) begin
