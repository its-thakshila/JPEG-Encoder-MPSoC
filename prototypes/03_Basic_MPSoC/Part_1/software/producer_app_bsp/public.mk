...
SOPCINFO_FILE := D:/MY_ACA/SEM_5/CO503-Advanced_Embedded_Systems/Lab_3_Part_1/soc_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x22040
SOPC_SYSID_FLAG += --sidp=0x22040
ELF_PATCH_FLAG  += --sidp 0x22040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1772008301
SOPC_SYSID_FLAG += --timestamp=1772008301
ELF_PATCH_FLAG  += --timestamp 1772008301
