...
(
    ...
    localparam PAD3 = log2ceil(64'h22020 - 64'h22000); 
    localparam PAD4 = log2ceil(64'h22040 - 64'h22020); 
    localparam PAD5 = log2ceil(64'h22048 - 64'h22040); 
    localparam PAD6 = log2ceil(64'h22050 - 64'h22048); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h22050;
    ...
    // ( 0x22020 .. 0x22040 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 18'h22020   ) begin
            src_channel = 12'b0001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x22040 .. 0x22048 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 18'h22040  && read_transaction  ) begin
            src_channel = 12'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x22048 .. 0x22050 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 18'h22048   ) begin
